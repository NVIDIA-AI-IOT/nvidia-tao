...
# Bash installation
sudo apt-get install libgeos-dev mpich libmpich-dev libhdf5-dev libopenmpi-dev -y
...
python3.8 -m pip install /localhome/local-rarunachalam/colab_notebooks/tensorflow/nvidia_tao_tf1-5.0.0.1-py3-none-any.whl
